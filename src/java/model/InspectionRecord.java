...
public class InspectionRecord {
    ...
    public java.math.BigDecimal getCO2Emission() { return co2Emission; }
    public void setCO2Emission(java.math.BigDecimal co2Emission) { this.co2Emission = co2Emission; }
    public java.math.BigDecimal getHCEmission() { return hcEmission; }
    public void setHCEmission(java.math.BigDecimal hcEmission) { this.hcEmission = hcEmission; }
